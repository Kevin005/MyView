 ...
 */
public class EarseView1 extends View {
    ...
    public EarseView1(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public EarseView1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public EarseView1(Context context) {
        super(context);
        init();
    }
